...
bagi2="$(($jumlahkata/2))"
echo "baris pertama diakhiri dikata: ke $bagi2"
garisbaru="$(($jumlahkata-$bagi2))"
...
busybox echo -e "\nbaris baru dimulai dari: $garisbaru dan diakhiri pada $jumlahkata\nmembuat baris baru...\n"
# > "$cwd/1.txt"
...
cat $cwd/numorder.srt >> $cwd/newSrt.srt
rm -f $cwd/numorder.srt
rm -f $@
# 1
echo "$0 oke..."
